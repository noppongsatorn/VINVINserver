...
<!-- Table Head -->
  <tr>
    ...
    <td width="100" style="text-align: center;">Tel</td>
    <td width="150" style="text-align: center;">Station</td>
    <td width="20" style="text-align: center;">No</td>
    <td width="200" style="text-align: center;">Model</td>
    <td width="50" style="text-align: center;">Credit</td>
    <td width="30" style="text-align: center;">Info</td>
  </tr>
...
for($count=1;$count<1000;$count++){
	$r = mysql_query("SELECT * FROM vin WHERE ID = ".$count/*.$Filter1*/);
